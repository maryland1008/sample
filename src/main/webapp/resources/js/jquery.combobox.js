...
(function($) {
    ...
    $.widget("jv.combobox", {
        ...
        , _create: function() {
            ...
            var inHtml = '<ul class="ui-widget ui-combobox"><li class="ui-widget-content"><a href="javascript:void(0);" class="ui-combobox-toggleText"></a><span class="ui-icon ui-icon-triangle-1-s"></span><ul class="ui-combobox-list ui-widget-content">';
            for (var i = 0; i < o.list.length; i++) {
                inHtml += "<li class='ui-state-default " + (o.list[i].selected == true ? "ui-state-highlight" : "") + "' valueAlt='" + o.list[i].value + "'><span>" + o.list[i].text + "</span></li>";
            }
            inHtml += '</ul></li></ul>';
            ...
            $el
                ...
                .find('ul.ui-combobox-list')
                    ...
                    .css('top', parseInt($el.find('li:first').outerHeight(true)))
