 ...
 *
 * Modified by Huaichen Yang for jQuery 1.4.4
 */
 ...
 *
 */
ajaxAddOption: function(url, params, select, fn, args)
{
 ...
 *
 */
sortOptions: function(ascending)
{
 ...
 *
 */
selectOptions: function(value, clear)
{
	var v = value;
	var vT = typeof(value);
	// handle arrays
 ...
 *
 */
containsOption: function(value, fn)
{
	var found = false;
	var v = value;
	var vT = typeof(v);
